...
class TestDistance(unittest.TestCase):
    ...
    def test_distance_all(self):
        self.assertEqual(distance_all(fred, neighbors), [{'avenue': 4, 'distance': 0.0, 'name': 'Fred', 'street': 8},
 ...
 {'avenue': 5, 'distance': 4.123105625617661, 'name': 'Natalie', 'street': 4}])
    ...
    def test_nearest_neighbors(self):
        self.assertEqual(nearest_neighbors(fred, neighbors, 2), [{'avenue': 4, 'distance': 0.0, 'name': 'Fred', 'street': 8},
            {'avenue': 5, 'distance': 1.0, 'name': 'Bob', 'street': 8}])
